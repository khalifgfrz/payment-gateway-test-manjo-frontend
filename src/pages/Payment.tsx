      ...
      <div className="card p-8">
        <div className="space-y-6">
          <div>
            ...
            <input type="text" name="referenceNo" placeholder="Masukkan nomor referensi (ex: REF-2024-001)" value={form.referenceNo} onChange={handleChange} onKeyPress={handleKeyPress} className="input" />
          </div>

          <div>
            <label className="block text-sm font-medium text-slate-700 mb-2">Amount (IDR) *</label>
            <input type="number" name="amount" placeholder="Masukkan jumlah pembayaran (ex: 100000)" value={form.amount} onChange={handleChange} onKeyPress={handleKeyPress} className="input" />
          </div>
